...
function CreateTicket() {
    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <h4 className="">
         <i class="fa fa-plus-circle me-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
          Account Opening
        </h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="">
         <i className="fa fa-user me-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className="">
            <i class="fa fa-bar-chart me-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
          Your Zerodha Account
        </h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-id-card m-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
          Funds
        </h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-circle-o-notch m-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
          Console
        </h4>
      ...
      <div className="col-4 p-5 mt-2 mb-2">
        <h4 className=""><i class="fa fa-circle-thin m-2" style={{fontSize: '18px'}} aria-hidden="true"></i>
          Coin
        </h4>
